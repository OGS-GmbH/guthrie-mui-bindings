...
export default defineConfig({
  ...
  title: "Guthrie MUI Bindings",
  description: "UI integration layer that connects the dynamic JSON-driven rendering capabilities of Guthrie with the component ecosystem of Material UI (MUI).",
  themeConfig: {
    ...
    nav: [
      ...
      { text: packageJson.version, items: [
        { text: "Repository", link: "https://github.com/OGS-GmbH/guthrie-mui-bindings" },
        { text: "Changelog", link: "https://github.com/OGS-GmbH/guthrie-mui-bindings/blob/main/CHANGELOG.md" },
  ...
  base: "/guthrie-mui-bindings/",
  srcDir: "../dist/vitepress-src",
  outDir: "../dist/docs",
  titleTemplate: ":title - OGS Guthrie MUI Bindings",
  cleanUrls: true,
  appearance: true,
  markdown: {
    config(md) {
